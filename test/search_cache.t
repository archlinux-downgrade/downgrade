...
From a single directory
  ...
  $ PACMAN_CONF=$CRAMTMP/pacman.conf DOWNGRADE_FROM_ALA=0 search_packages 'foo' | sort
...
With a version string included
  ...
  $ PACMAN_CONF=$CRAMTMP/pacman.conf DOWNGRADE_FROM_ALA=0 search_packages 'foo-1' | sort
